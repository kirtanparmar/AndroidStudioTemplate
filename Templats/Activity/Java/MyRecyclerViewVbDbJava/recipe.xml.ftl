...
<recipe>
	...
	<instantiate from="src/app_package/EmptyAdapter.java.ftl"
                 to="${escapeXmlAttribute(srcOut)}/${activityName}ListAdapter.java" />
	
    <open file="${escapeXmlAttribute(srcOut)}/${activityName}Activity.java}" />
	<open file="${escapeXmlAttribute(srcOut)}/${activityName}ListAdapter.java}" />
